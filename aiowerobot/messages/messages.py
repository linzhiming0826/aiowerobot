...
from aiowerobot.messages.entries import StringEntry, IntEntry, FloatEntry
from aiowerobot.messages.base import AioWeRoBotMetaClass


class MessageMetaClass(AioWeRoBotMetaClass):
    pass
